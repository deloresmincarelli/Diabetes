...
# Displays a web page interface with excerpt from a database table
# Prompts the user for a question regarding the database table
# Prompt is done using natural language and connects to the OpenAI large language model (LLM)
# The LLM interprets the request and converts to sql
# The sql is run in pandas to generate the response
...
# st = streamlit
def get_text():
    input_text = st.text_input("You: ","Hello, how can I help?  Type question here:", key="input")
    return input_text
...
with col1:
    st.header("Diabetes Data")
    
    # tab1 = st.tabs(["Diabetes Predictions"])
